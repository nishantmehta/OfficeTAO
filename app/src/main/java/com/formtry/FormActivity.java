...
public abstract class
        FormActivity extends FragmentActivity
{
	...
	public static final LayoutParams defaultLayoutParams = new LayoutParams( LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT);
	...
	public void generateForm( String data )
	{
		...
		// -- create the layout
        _container = (LinearLayout)findViewById(R.id.form_container);
       ...
       _viewport.setLayoutParams(new ScrollView.LayoutParams(ScrollView.LayoutParams.MATCH_PARENT,ScrollView.LayoutParams.MATCH_PARENT));
